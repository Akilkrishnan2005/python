...
def login():
    subprocess.Popen([sys.executable,r"C:\DATA SCIENCE\PYTHON PROJECT\VEHICLE SERVICE MANGEMENT SYSTEM\LOGIN PAGE.py"])

def sign():
    subprocess.Popen([sys.executable,r"C:\DATA SCIENCE\PYTHON PROJECT\VEHICLE SERVICE MANGEMENT SYSTEM\SIGN UP PAGE.py"])
...
# Load Image 
img = Image.open(r"C:\Users\akilk\Downloads\Blue Eclipse Car new.jpeg")  
